...
export function ContactInfoBlock() {
  return (
    <div className="flex flex-col gap-5 rounded-xl border border-border bg-background p-6">
      <h2 className="text-[11px] font-black uppercase tracking-widest text-[--lime-dark]">
        Où me trouver
      </h2>
      <ul className="flex flex-col gap-4 text-sm">
        <li className="flex items-start gap-3">
          ...
          <div className="flex flex-col gap-1">
            <p className="text-[11px] font-black uppercase tracking-widest text-[--lime-dark]">
              Adresse
            </p>
        ...
        <li className="flex items-start gap-3">
          ...
          <div className="flex flex-col gap-1">
            <p className="text-[11px] font-black uppercase tracking-widest text-[--lime-dark]">Courriel</p>
            <a
        ...
        <li className="flex items-start gap-3">
          ...
          <div className="flex flex-col gap-1">
            <p className="text-[11px] font-black uppercase tracking-widest text-[--lime-dark]">Téléphone</p>
            <a
        ...
        <li className="flex items-start gap-3">
          ...
          <div className="flex flex-col gap-1">
            <p className="text-[11px] font-black uppercase tracking-widest text-[--lime-dark]">Délai de réponse</p>
            <p className="text-foreground/75">
